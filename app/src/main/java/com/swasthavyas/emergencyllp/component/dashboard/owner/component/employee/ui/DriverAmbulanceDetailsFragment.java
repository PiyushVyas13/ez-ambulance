...
public class DriverAmbulanceDetailsFragment extends Fragment {
    ...
    public Data collectData() {
        ...
        dataBuilder.putString(EmployeeDriver.ModelColumns.ASSIGNED_AMBULANCE_NUMBER, ambulanceNumber);
        dataBuilder.putString(EmployeeDriver.ModelColumns.AADHAAR_NUMBER, viewBinding.aadhaarnoDriver.getText().toString());
